...
<<<<<<< HEAD
            ...
            OptionCommandColist = BooleanOptionItem.Create(1_601_270, "DisableCommandColist", false, TabGroup.MainSettings, true)
                .SetParent(OptionCommandSetting)
                .SetColorcode("#00c1ff")
                .SetOptionName(() => "/colist, /cl - COの一覧を表示");

            OptionCommandAco = BooleanOptionItem.Create(1_601_280, "DisableCommandAco", false, TabGroup.MainSettings, true)
                .SetParent(OptionCommandSetting)
                .SetColorcode("#00c1ff")
                .SetOptionName(() => "/aco - 属性をCO(宣言)する");

            OptionCommandAcl = BooleanOptionItem.Create(1_601_290, "DisableCommandAcl", false, TabGroup.MainSettings, true)
                .SetParent(OptionCommandSetting)
                .SetColorcode("#00c1ff")
