...
namespace TownOfHost
{
    ...
    public class Main : BasePlugin
    {
        ...
        public static readonly string ForkId = "TOH-hm";
        ...
        public const string BepInExPluginVersion = "4.00.00.01";
        public const string PluginVersion = "4.00.00.01";//ほんとはx.y.z表記にしたかったけどx.y.z.km.ks表記だと警告だされる
        public const string PluginShowVersion = "4.00.00.01";
        public const string ModVersion = ".00.01";//リリースver用バージョン変更dc9b79
        ...
        // ↓↓↓ ここにDiscord中継BotのURLを直接書く（cloudflaredのURLが変わったら書き換える）↓↓↓
        // 例: "https://xxxx.trycloudflare.com/matchmaking" や "https://your-worker.workers.dev/"
        // 空文字か"none"だとDiscord通知機能は無効
        public static readonly string MatchmakingRelayUrl = "https://museum-station-zinc-certification.trycloudflare.com/matchmaking";
        // 中継サーバー側で認証シークレットを設定した場合はここにも同じ文字列を入れる（任意）
        ...
        public static bool IsPublicRoomAllowed(bool AllowCS = true)
        {
            ...
            return !ModUpdater.hasUpdate
                && AllowPublicRoom
                && IsPublicAvailableOnThisVersion;
        }
